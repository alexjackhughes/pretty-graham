...
---
 ...
 <!-- 
 (new Image).src="https://store.yahoo.net/cgi-bin/refsd?e=http://www.paulgraham.com/newideas.html&h=www.paulgraham.com&v=1.0&dr=" + escape(document.referrer); 
 -->
...
| Crazy New IdeasMay 2021There's one kind of opinion I'd be very afraid to express publicly.
...
[[1](#f1n)]Such ideas are not merely unsafe to dismiss, but disproportionately
...
[[2](#f2n)]Such ideas are not guaranteed to work. But they don't have to be.
...
[[3](#f3n)]The wise response to such an idea is not to make statements, but
...
[[4](#f4n)]Paradigms don't just define our present thinking. They also vacuum
...
[[5](#f5n)]Few understand how feeble new ideas look when they first appear.
...
_Structure of Scientific Revolutions_, but I also recommend his
_Copernican Revolution_, where you can see him at work developing the
idea.[4]
...
instruments.[5]
Hall, Rupert. _From Galileo to Newton._ Collins, 1963. This
