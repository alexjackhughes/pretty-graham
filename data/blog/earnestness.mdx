...
---
 ...
 <!-- 
 (new Image).src="https://store.yahoo.net/cgi-bin/refsd?e=http://www.paulgraham.com/earnest.html&h=www.paulgraham.com&v=1.0&dr=" + escape(document.referrer); 
 -->
...
| EarnestnessDecember 2020Jessica and I have certain words that have special significance
...
[[1](#f1n)]The reason motives matter so much in Silicon Valley is that so many
...
earnestness.
[[2](#f2n)]It's also the hallmark of a nerd. Indeed, when people describe
...
for its sake.A [genuine interest](genius.html)
...
very funny.
[[4](#f4n)]Looking at the list of fields I mentioned, there's an obvious
...
forget about them.
[[5](#f5n)]It works to be slightly naive not just about motives but also,
...
[[6](#f6n)]Can you imagine a more important change than one in the relationship
...
It's interesting how many different ways there are _not_ to
