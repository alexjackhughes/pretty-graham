...
---
 ...
 <!-- 
 (new Image).src="https://store.yahoo.net/cgi-bin/refsd?e=http://www.paulgraham.com/worked.html&h=www.paulgraham.com&v=1.0&dr=" + escape(document.referrer); 
 -->
...
| What I Worked OnFebruary 2021Before college the two main things I worked on, outside of school,
...
[[1](#f1n)]The first of my friends to get a microcomputer built it himself.
...
nagging before I convinced my father to buy one, a TRS-80, in about 1980. The gold standard then was the Apple II, but a TRS-80 was
...
called _The Moon is a Harsh Mistress_, which featured an intelligent
computer called Mike, and a PBS documentary that showed Terry
Winograd using SHRDLU. I haven't tried rereading _The Moon is a Harsh
Mistress_, so I don't know how well it has aged, but when I read it
...
learn it. The book, _On Lisp_, wasn't published till 1993, but I wrote
...
things in profiles in _Life_ magazine. The idea of actually being
...
working away at _On Lisp_. In other words, like many a grad student,
...
remained before the deadline, reusing parts of _On Lisp_ where I
...
all I had to do was learn Italian.Only _stranieri_ (foreigners) had to take this entrance exam. In
retrospect it may well have been a way of excluding them, because
there were so many _stranieri_ attracted by the idea of studying
...
vocabulary.
[[2](#f2n)]I'm only up to age 25 and already there are such conspicuous patterns.
...
old.
[[3](#f3n)]While I was a student at the Accademia I started painting still
...
sense.
[[4](#f4n)]I liked painting still lives because I was curious about what I was
...
[[5](#f5n)]Interleaf had done something pretty bold. Inspired by Emacs, they'd
...
spent much of my time surreptitiously working on _On Lisp_, which I
...
[[6](#f6n)]There were plenty of earnest students too: kids who "could draw"
...
[[7](#f7n)]Asterix comics begin by zooming in on a tiny corner of Roman Gaul
...
this book, _ANSI Common Lisp_, is one that I painted around this
...
of _ANSI Common Lisp_ to the publishers, we started trying to write
...
[[8](#f8n)]There were three main parts to the software: the editor, which
...
[[10](#f10n)]Wow, I thought, there's an audience. If I write something and put
...
[essays](essay.html).
[[11](#f11n)]In the print era, the channel for publishing essays had been
...
to write them.
[[12](#f12n)]I've worked on several different things, but to the extent there
...
published in _The New Yorker_. But by this point I knew enough to
...
book, called _Hackers & Painters_ after one of the essays in it. I
...
[interviews](https://www.amazon.com/Founders-Work-Stories-Startups-Early/dp/1430210788) with startup founders.When the bank had financial problems and she had to fire half her
...
[[13](#f13n)]Once again, ignorance worked in our favor. We had no idea how to
...
[[14](#f14n)]The most distinctive thing about YC is the batch model: to fund a
...
[[16](#f16n)]Fairly quickly I realized that we had stumbled upon the way to scale
...
[[17](#f17n)]As well as HN, I wrote all of YC's internal software in Arc. But
while I continued to work a good deal _in_ Arc, I gradually stopped
working _on_ Arc, partly because I didn't have time to, and partly
...
[[18](#f18n)]I spent most of the rest of 2014 painting. I'd never been able to
...
[[19](#f19n)]McCarthy didn't realize this Lisp could even be used to program
...
at it for so long.I wrote this new Lisp, called [Bel](bel.html),
...
like _polluzione_). It's the everyday words that differ. So if you
