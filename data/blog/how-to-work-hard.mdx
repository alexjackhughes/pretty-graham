...
---
 ...
 <!-- 
 (new Image).src="https://store.yahoo.net/cgi-bin/refsd?e=http://www.paulgraham.com/hwh.html&h=www.paulgraham.com&v=1.0&dr=" + escape(document.referrer); 
 -->
...
| How to Work HardJune 2021It might not seem there's much to learn about how to work hard.
...
_and_ to have practiced a lot _and_ to be trying very hard.
[[1](#f1n)]Bill Gates, for example, was among the smartest people in business
...
feels awful.
[[2](#f2n)]There wasn't a single point when I learned this. Like most little
...
love it. Hardy wrote eloquently about this in _A Mathematician's
Apology_:
...
_Principia_, but it all feels necessary. That's a vague criterion,
but it's deliberately vague, because it has to cover a lot of
different types.
[[4](#f4n)]Once you know the shape of real work, you have to learn how many
...
vacations.
[[5](#f5n)]The only way to find the limit is by crossing it. Cultivate a
...
then to yourself.
[[6](#f6n)]Finding the limit of working hard is a constant, ongoing process,
...
[[8](#f8n)]The difficulty of figuring out what to work on varies enormously
...
[[9](#f9n)]What even counts as good results? That can be really hard to decide.
...
motivations. The thing to avoid is _unconsciously_ letting the need
