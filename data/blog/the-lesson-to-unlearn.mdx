...
---
 ...
 <!-- 
 (new Image).src="https://store.yahoo.net/cgi-bin/refsd?e=http://www.paulgraham.com/lesson.html&h=www.paulgraham.com&v=1.0&dr=" + escape(document.referrer); 
 -->
...
| The Lesson to UnlearnDecember 2019
...
[get it started](ds.html).At this point I've told the founders something you'd think would
...
fact that the same test has to be given to large numbers of students.[3] Learning is the naive algorithm for getting good grades.[4] [Hacking](gba.html) has
