...
layout: PostSimple
canonicalUrl: http://www.paulgraham.com/own.html
...
stuff kids do as different from real work.[[1](#f1n)]
...
own, I wanted to hear all about those.[[2](#f2n)]
...
voluntarily, rather than merely because someone told you to, and 2) that you're doing it by yourself.
...
[[3](#f3n)]These two paths into collaboration can of course be combined. But
...
[[4](#f4n)]The team that made the original Macintosh were a great example of
...
[[5](#f5n)]The natural alignment between skating and solving new problems is
...
[1]
"Hobby" is a curious word. Now it means work that isn't _real_
